 ...
 */
@Entity
@Table(name = "cm_quotation_last_demand", schema = "testssx", catalog = "")
public class CmQuotationLastDemandEntity {
    private int id;
    private String type;
    private Integer itemUserId;
    private Integer itemId;
    private Integer lastQuotationUserId;
    ...
    @Basic
    @Column(name = "LastQuotationUserID")
    public Integer getLastQuotationUserId() {
        return lastQuotationUserId;
    }

    public void setLastQuotationUserId(Integer lastQuotationUserId) {
        this.lastQuotationUserId = lastQuotationUserId;
    }
    ...
    public boolean equals(Object o) {
        ...
        CmQuotationLastDemandEntity that = (CmQuotationLastDemandEntity) o;

        if (id != that.id) return false;
        if (type != null ? !type.equals(that.type) : that.type != null) return false;
        if (itemUserId != null ? !itemUserId.equals(that.itemUserId) : that.itemUserId != null) return false;
        if (itemId != null ? !itemId.equals(that.itemId) : that.itemId != null) return false;
        if (lastQuotationUserId != null ? !lastQuotationUserId.equals(that.lastQuotationUserId) : that.lastQuotationUserId != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (lastQuotationUserId != null ? lastQuotationUserId.hashCode() : 0);
