...
public  class StringTools {
    ...
    public static String getPinYin(String cnStr) { 
    	return ChineseConvert.getPinYin(cnStr);
    }
    /**
     * 得到首字母拼音
     * @param cnStr
     * @return
     */
    public static String getPinYinIndex(String cnStr) {
    	return ChineseConvert.getPinYinIndex(cnStr);
    }
